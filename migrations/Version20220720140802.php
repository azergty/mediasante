 ...
 */
final class Version20220720140802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book_renting (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, book_id INT NOT NULL, renting_start DATETIME NOT NULL, renting_end DATETIME DEFAULT NULL, limit_date DATETIME NOT NULL, INDEX IDX_80731499A76ED395 (user_id), INDEX IDX_8073149916A2B381 (book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
